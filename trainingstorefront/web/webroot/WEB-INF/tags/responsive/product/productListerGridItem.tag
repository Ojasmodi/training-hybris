	...
	<ycommerce:testId code="product_wholeProduct">
		...
		<div class="details">
			<ycommerce:testId code="product_productName">
				<a class="name" href="${fn:escapeXml(productUrl)}"> <c:out
						escapeXml="false" value="${ycommerce:sanitizeHTML(product.name)}" />
				</a>
			</ycommerce:testId>
			...
			<c:if test="${product.giftWrapAvailable=='true'}">
				<p style="color: green">
					<b>Gift Wrap Available</b>
				<p>
			</c:if>
			<c:if test="${product.giftWrapAvailable=='false'}">
				<p style="color: red">
					<b>No Gift Wrap Available</b>
				<p>
			</c:if>
