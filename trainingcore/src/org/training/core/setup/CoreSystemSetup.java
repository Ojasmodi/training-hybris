...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		// importing custom impex file for gift-wrap
		//importImpexFile(context, "/trainingcore/import/common/giftwrap-data.impex");

		//importing localized data for gift-wrap
		importImpexFile(context, "/trainingcore/import/common/giftwrap-data-locale.impex");
		importImpexFile(context, "/trainingcore/import/common/giftwrap-data-locale_en.impex");
		importImpexFile(context, "/trainingcore/import/common/giftwrap-data-locale_de.impex");
